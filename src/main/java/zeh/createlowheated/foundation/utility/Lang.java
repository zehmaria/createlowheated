package zeh.createlowheated.foundation.utility;
...
public class Lang {
    ...
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(CreateLowHeated.ID + "." + key, resolveBuilders(args));
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(CreateLowHeated.ID);
    }
